                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                            <img src="<?php if($user->profile_photo != ''): ?><?php echo e(URL::asset('storage/images/users/' . $user->profile_photo)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/noImage.png')); ?><?php endif; ?>" alt="" class="img-thumbnail rounded-circle">
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo e(url('/doctor')); ?>" class="mb-0 fw-medium font-size-15">
                                        <h5 class="mb-0"><?php echo e(number_format($data['total_doctors'])); ?></h5>
                                    </a>
                                    <p class="text-muted mb-0"><?php echo e(__('translation.doctors')); ?></p>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo e(url('/patient')); ?>" class="mb-0 fw-medium font-size-15">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo e(url('/accountant')); ?>"
                                        class="mb-0 fw-medium font-size-15">
                                        <h5 class="mb-0"><?php echo e(number_format($data['total_accountants'])); ?>

                                        </h5>
                                    </a>
                                    <p class="text-muted mb-0"><?php echo e(__('translation.accountant')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p class="text-muted">
                            <span class="<?php if($data['monthly_diff'] > 0): ?> text-success <?php else: ?> text-danger <?php endif; ?> me-2">
                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <button
                                class="btn  <?php echo e($per_page == 10 ? 'btn-primary' : 'btn-info'); ?>  btn-sm me-2 per-page-items  mb-md-1"
                                data-page="10">10</button>
                            <button
                                class="btn  <?php echo e($per_page == 25 ? 'btn-primary' : 'btn-info'); ?>  btn-sm me-2 per-page-items  mb-md-1"
                                data-page="25">25</button>
                            <button
                                class="btn  <?php echo e($per_page == 50 ? 'btn-primary' : 'btn-info'); ?>  btn-sm me-2 per-page-items  mb-md-1"
                                data-page="50">50</button>
                            <button
                                class="btn  <?php echo e($per_page == 100 ? 'btn-primary' : 'btn-info'); ?>  btn-sm me-2 per-page-items  mb-md-1"
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.revenue')); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__("translation.today's-earning")); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__("translation.today's-appointments")); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.tomorrow-appointments')); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.upcoming-appointments')); ?></p>
...
<!-- end row -->
<?php /**PATH /Users/user/Downloads/Doctorly_Laravel_v3.1.0/Admin/resources/views/layouts/admin-dashboard.blade.php ENDPATH**/ ?>