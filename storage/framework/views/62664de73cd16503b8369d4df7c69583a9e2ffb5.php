    ...
    <div class="row">
        <div class="col-12">
            <a href="<?php echo e(url('/appointment/create')); ?>" class="btn btn-primary text-white waves-effect waves-light mb-4">
                <i class="mdi mdi-arrow-left  font-size-16 align-middle me-2"></i> <?php echo e(__('Back')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option hidden selected disabled><?php echo e(__('Select')); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label class="control-label"><?php echo e(__('Date ')); ?><span class="text-danger">*</span></label>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Downloads/Doctorly_Laravel_v3.1.0/Admin/resources/views/appointment/appointment_create.blade.php ENDPATH**/ ?>