                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Get your free <?php echo e(AppSetting('title')); ?> Patient account now.</p>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">By registering you agree to the <?php echo e(AppSetting('title')); ?> <a href="#" class="text-primary"><?php echo e(__("Terms of Use")); ?></a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="mt-5 text-center">
                        <p><?php echo e(__("Already have an account ?")); ?> <a href="<?php echo e(url('login')); ?>"
                                class="fw-medium text-primary"><?php echo e(__("Login")); ?> </a> </p>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Downloads/Doctorly_Laravel_v3.1.0/Admin/resources/views/auth/register.blade.php ENDPATH**/ ?>