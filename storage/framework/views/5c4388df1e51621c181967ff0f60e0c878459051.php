                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Complete your <?php echo e(AppSetting('title')); ?> account first.</p>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                                        name="gender">
                                                        <option hidden selected disabled><?php echo e(__('-- Select Gender --')); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label"><?php echo e(__('Profile Photo ')); ?><span
                                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        placeholder="<?php echo e(__('Enter Height In Centimeter')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                        name="b_group">
                                                        <option hidden selected disabled><?php echo e(__('-- Select Blood Group --')); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                                        name="diet">
                                                        <option hidden selected disabled><?php echo e(__('-- Select Diet --')); ?></option>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Downloads/Doctorly_Laravel_v3.1.0/Admin/resources/views/profile-details.blade.php ENDPATH**/ ?>