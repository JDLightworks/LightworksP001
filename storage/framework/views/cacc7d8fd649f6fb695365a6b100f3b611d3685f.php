        ...
        <div class="row">
            <div class="col-12">
                <a href="<?php echo e(url('/appointment-create')); ?>"
                    ...
                    <i class="bx bx-plus font-size-16 align-middle me-2"></i> <?php echo e(__('New Appointment')); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Downloads/Doctorly_Laravel_v3.1.0/Admin/resources/views/appointment/appointment.blade.php ENDPATH**/ ?>